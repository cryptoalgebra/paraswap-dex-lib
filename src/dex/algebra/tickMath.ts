...
export abstract class TickMath {
   ...
   */
  public static getSqrtRatioAtTick(tick: number): JSBI | null {
    if (
   ...
   */
  public static getTickAtSqrtRatio(sqrtRatioX96: JSBI): number | null {
    if (
      JSBI.LT(sqrtRatioX96, TickMath.MIN_SQRT_RATIO) ||
      JSBI.GE(sqrtRatioX96, TickMath.MAX_SQRT_RATIO)
    )
      return null;
